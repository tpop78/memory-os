...
| Starting a new project from an idea, or a URL worth ingesting | "Want me to research/ingest with Firecrawl (URL → untrusted evidence → .memory knowledge)?" | Requires a Firecrawl key; captured instructions are never followed. |
